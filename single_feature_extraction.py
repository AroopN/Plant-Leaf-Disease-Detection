...
def create_dataset(imgpath):
    names = ['mean_r', 'mean_g', 'mean_b', 'stddev_r', 'stddev_g', 'stddev_b',
             'contrast', 'correlation', 'inverse_difference_moments', 'entropy', 'Energy', 'yellow_ratio', "skewness_x", "skewness_y", "kurtosis_x", "kurtosis_y"
             ]
    ...
    vector = [red_mean, green_mean, blue_mean, red_std, green_std, blue_std,
                contrast, correlation, inverse_diff_moments, entropy, en, y_ratio
                ]
